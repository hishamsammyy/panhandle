...
//define glabal edit text variables to store the entered data from the edit text so that it could be accessed from any where
    EditText editTextPbase,editTextTbase,editTextP1,editTextP2,editTextT,editTextD,editTextL,editTextE,editTextG,editTextH2H1,editTextZ,editTextVi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //linking all spinner variables with their corresponding spinner elements in the main activity
        ...
        //linking all edit text variables with their corresponding edit text elements in the main activity
        editTextPbase = (EditText) findViewById(R.id.editTextPbase);
        editTextTbase = (EditText) findViewById(R.id.editTextTbase);
        ...
        editTextH2H1 = (EditText) findViewById(R.id.editTextH2H1);
        editTextZ = (EditText) findViewById(R.id.editTextZ);
        editTextVi = (EditText) findViewById(R.id.editTextVi);
